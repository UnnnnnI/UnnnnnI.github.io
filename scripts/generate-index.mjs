...
.hp-label{font-size:11px;font-weight:500;letter-spacing:.1em;text-transform:uppercase;opacity:.45;padding:2rem 0 1rem;margin:0}
.hp-cards{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin-bottom:2.5rem}
.hp-card{background:rgba(128,128,128,.06);border-radius:12px;padding:1.4rem 1.2rem;text-decoration:none!important;display:block}
.hp-card:hover{background:rgba(128,128,128,.11)}
...
.hp-post{display:flex;align-items:baseline;gap:14px;padding:11px 0;border-bottom:1px solid rgba(128,128,128,.12);text-decoration:none!important}
.hp-post:last-child{border-bottom:none}
...
.hp-book{display:flex;align-items:baseline;gap:10px;padding:9px 0;border-bottom:1px solid rgba(128,128,128,.12);text-decoration:none!important}
.hp-book:last-child{border-bottom:none}
...
<div class="hp-hero">
  <h1 class="hp-title">연결을 위한 정리</h1>
  <p class="hp-sub">공부한 것들, 읽은 것들, 살아가는 것들.<br>모든 것은 어딘가에서 연결됩니다.</p>
</div>

<hr class="hp-divider">
<p class="hp-label">탐색</p>
